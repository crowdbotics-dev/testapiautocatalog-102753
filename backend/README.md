...
## Project Structure
    ...
    ├── testapiautocatalog_102753  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_102753`
...
2. Clone this repo and `cd testapiautocatalog_102753`
